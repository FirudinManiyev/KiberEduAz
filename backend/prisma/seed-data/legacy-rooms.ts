// Generated by scripts/extract-legacy-rooms.mjs from
// frontend/src/data/rooms.ts. Consumed once by prisma/seed.ts; the database is
...
export type LegacyRoom = {
  ...
  difficulty: "Başlanğıc" | "Orta" | "Çətin";
  duration: string;
  points: number;
  progress: number;
  learners: number;
...
export const legacyRooms: LegacyRoom[] = [
  {
