...
export const FAQ_ITEMS: readonly FaqItem[] = [
  ...
  { id: "platform-paths", category: "Platforma", question: "Hansı öyrənmə istiqamətləri mövcuddur?", answer: "Hazırda hücum təhlükəsizliyi üçün Red Team, müdafiə və SOC analizi üçün Blue Team, idarəetmə və risk mövzuları üçün isə GRC istiqamətləri mövcuddur." },
  ...
  { id: "room-sync", category: "Room və progress", question: "Bütün Room-lar hesabımla sinxronlaşır?", answer: "Hazırda əvvəlki iki API Room-u hesabınla sinxronlaşır, yeni beş Markdown Room-u isə cihazda saxlanılır. Kartdakı nişan hər Room-un hansı progress rejimindən istifadə etdiyini göstərir." },
  ...
  { id: "teacher-content", category: "Müəllim və təhlükəsizlik", question: "Müəllimlər öz dərslərini əlavə edə biləcəklər?", answer: "Platforma əsas öyrənmə və idarəetmə axınını təqdim edir. Müəllimlər üçün Room hazırlamaq, sinfə təyin etmək və iştirak nəticələrini izləmək imkanları mərhələli şəkildə genişləndiriləcək." },
